...
public class InputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCategoryEdit = (EditText) findViewById(R.id.category_edit_text); //カテゴリーを追加した
        ...
        if (mTask == null) {
            ...
            mCategoryEdit.setText(mTask.getCategory());//カテゴリーを追加した
    ...
    private void addTask() {
        ...
        String category = mCategoryEdit.getText().toString();//カテゴリーを追加した

        mTask.setTitle(title);
        mTask.setContents(content);
        mTask.setCategory(category);//カテゴリーを追加した
